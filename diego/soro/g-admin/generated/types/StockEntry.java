...
public class StockEntry {
  ...
  public String toString() {
    return "StockEntry{id='" + id + "', rawMaterialId='" + rawMaterialId + "', quantity='" + quantity + "', cost='" + cost + "', reason='" + reason + "', timestamp='" + timestamp + "', operationType='" + operationType + "', notes='" + notes + "'}";
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, rawMaterialId, quantity, cost, reason, timestamp, operationType, notes);
  }
