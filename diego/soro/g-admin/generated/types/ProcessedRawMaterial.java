...
public class ProcessedRawMaterial implements diego.soro.g-admin.generated.types.RawMaterial {
  private String id;
  ...
  public String toString() {
    return "ProcessedRawMaterial{id='" + id + "', name='" + name + "', categoryId='" + categoryId + "', rawMaterialType='" + rawMaterialType + "', cost='" + cost + "', quantity='" + quantity + "', measurementUnit='" + measurementUnit + "', recipe='" + recipe + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessedRawMaterial that = (ProcessedRawMaterial) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, categoryId, rawMaterialType, cost, quantity, measurementUnit, recipe);
  }
  ...
  public static class Builder {
    ...
    public ProcessedRawMaterial build() {
      ProcessedRawMaterial result = new ProcessedRawMaterial();
      result.id = this.id;
